...
export const MIN_IMG_WIDTH_PAGE_PAGE = 100; // image widht on the page (the real image widht might be different)
export const MIN_IMG_HEIGHT_PAGE_PAGE = 100; // image height on the page (the real image height might be different)
